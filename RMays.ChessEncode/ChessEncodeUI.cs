...
namespace RMays.ChessEncode
{
    public partial class ChessEncodeUI : Form
    {
        ...
        private void PrintBoard()
        {
            ...
            for (int r = 1; r <= 8; r++)
            {
                for (int f = 1; f <= 8; f++)
                {
                    ...
                    squares[f - 1, r - 1] = GetPieceWithOffset(f, r, offsets.Item1, offsets.Item2);
                }
            }
            this.ResumeLayout();
        }
        ...
        private void PrintBoard_old()
        {
            ...
            for (int r = 1; r <= 8; r++) // rank (row)
            {
                for (int f = 1; f <= 8; f++) // file (col)
                {
                    ...
                    squares[f - 1, r - 1] = GetPieceWithOffset(f, r, r, f);
                }
            }
        ...
        private PictureBox GetPieceWithOffset(int f, int r, int row, int col)
        {
